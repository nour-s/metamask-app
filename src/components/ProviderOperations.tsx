...
async function connectToMobileWallet() {
    const sdk = new MetaMaskSDK();
    const accounts = await sdk.connect();
    const provider: EIP6963ProviderDetail = {
        provider: sdk.getProvider(), info: {
    ...
    console.log('Connected to mobile wallet:', accounts, provider)
    return [accounts, provider]
}

export { getTransactions, getBalance, sendTransaction, switchToLineaSepoliaNetwork, connectToMobileWallet }
export type { Account }
